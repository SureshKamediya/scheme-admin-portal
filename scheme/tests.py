...
# #         app = Application(scheme=self.scheme)
# #         app.save()

# #         app.refresh_from_db()
# #         self.scheme.refresh_from_db()

# #         self.assertEqual(app.application_number, 1)
# #         self.assertEqual(self.scheme.next_application_number, 2)
...
# #         self.assertEqual(self.scheme.next_application_number, 6)
